from list_function.py import pre_info_tweets, pre_info_insta, merge_datasets, remove_duplication_coor, add_category, grid_creation, remove_outliers, cluster_with_clusterpy



script, in_file1, in_file2 = argv
